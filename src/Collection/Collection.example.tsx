...
export default class CollectionExample extends React.PureComponent {
  ...
  render() {
    ...
    return <ContentBox>
        <ContentBoxHeader text="Collection" sourceLink="https://github.com/bvaughn/react-virtualized/blob/master/source/Collection/Collection.example.js" docsLink="https://github.com/bvaughn/react-virtualized/blob/master/docs/Collection.md" />
        ...
        <ContentBoxParagraph>
          <label className={styles.checkboxLabel}>
            <input aria-label="Show placeholder while scrolling?" checked={showScrollingPlaceholder} className={styles.checkbox} type="checkbox" onChange={event => this.setState({
        ...
        <InputRow>
          ...
          <LabeledInput label="Horizontal Overscan" name="horizontalOverscanSize" onChange={this._onHorizontalOverscanSizeChange} value={horizontalOverscanSize} />
        ...
        <AutoSizer disableHeight>
          {({
          width
        }) => <Collection cellCount={cellCount} cellRenderer={this._cellRenderer} cellSizeAndPositionGetter={this._cellSizeAndPositionGetter} className={styles.collection} height={height} horizontalOverscanSize={horizontalOverscanSize} noContentRenderer={this._noContentRenderer} scrollToCell={scrollToCell} verticalOverscanSize={verticalOverscanSize} width={width} />}
        </AutoSizer>
      </ContentBox>;
  }
  ...
  _cellRenderer({
    ...
    return <div className={styles.cell} key={key} style={style}>
        {showScrollingPlaceholder && isScrolling ? '...' : index}
      </div>;
  }

  _cellSizeAndPositionGetter({
    index
  }) {
    const {
      list
