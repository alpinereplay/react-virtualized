...
class CellMeasurerCache {
    ...
    constructor(params = {}) {
        ...
        this._defaultHeight = Math.max(this._minHeight, typeof defaultHeight === "number" ? defaultHeight : exports.DEFAULT_HEIGHT);
        this._defaultWidth = Math.max(this._minWidth, typeof defaultWidth === "number" ? defaultWidth : exports.DEFAULT_WIDTH);
        if (process.env.NODE_ENV !== "production") {
            if (this._hasFixedHeight === false &&
    ...
    getHeight(rowIndex, columnIndex = 0) {
        if (this._hasFixedHeight) {
            ...
            return this._cellHeightCache[key] !== undefined
                ? Math.max(this._minHeight, this._cellHeightCache[key] ?? 0)
                : this._defaultHeight;
        }
    }
    getWidth(rowIndex, columnIndex = 0) {
        if (this._hasFixedWidth) {
            ...
            return this._cellWidthCache[key] !== undefined
                ? Math.max(this._minWidth, this._cellWidthCache[key] ?? 0)
                : this._defaultWidth;
        }
    }
