...
const ScalingCellSizeAndPositionManager_1 = __importDefault(require("./ScalingCellSizeAndPositionManager"));
describe("ScalingCellSizeAndPositionManager", () => {
    function init({ cellCount = 10, cellSize = 10, estimatedCellSize = 10, maxScrollSize = 50, } = {}) {
        const cellSizeAndPositionManager = new ScalingCellSizeAndPositionManager_1.default({
            cellCount,
