...
describe('AutoSizer', () => {
  function getMarkup({
    ...
    return <div style={wrapperStyle}>
        <AutoSizer className={className} defaultHeight={defaultHeight} defaultWidth={defaultWidth} disableHeight={disableHeight} disableWidth={disableWidth} onResize={onResize} style={style}>
          {({
          height,
          width
        }) => <ChildComponent width={disableWidth ? undefined : width} height={disableHeight ? undefined : height} bar={bar} foo={foo} />}
        </AutoSizer>
      </div>;
  }
