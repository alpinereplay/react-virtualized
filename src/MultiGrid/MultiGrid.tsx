...
class MultiGrid extends React.PureComponent {
  ...
  render() {
    ...
    return <div style={this._containerOuterStyle}>
        <div style={this._containerTopStyle}>
          {this._renderTopLeftGrid(rest)}
          {this._renderTopRightGrid({ ...rest,
          onScroll,
          scrollLeft
        })}
        </div>
        <div style={this._containerBottomStyle}>
          {this._renderBottomLeftGrid({ ...rest,
          onScroll,
          scrollTop
        })}
          {this._renderBottomRightGrid({ ...rest,
          onScroll,
          onSectionRendered,
          scrollLeft,
          scrollToColumn,
  ...
  _cellRendererBottomLeftGrid = ({
    ...
    if (rowIndex === rowCount - fixedRowCount) {
      return <div key={rest.key} style={{ ...rest.style,
        height: SCROLLBAR_SIZE_BUFFER
      }} />;
    } else {
      return cellRenderer({ ...rest,
        parent: this,
  ...
  _renderBottomLeftGrid(props) {
    ...
    const bottomLeftGrid = <Grid {...props} cellRenderer={this._cellRendererBottomLeftGrid} className={this.props.classNameBottomLeftGrid} columnCount={fixedColumnCount} deferredMeasurementCache={this._deferredMeasurementCacheBottomLeftGrid} height={height} onScroll={enableFixedColumnScroll ? this._onScrollTop : undefined} ref={this._bottomLeftGridRef} rowCount={Math.max(0, rowCount - fixedRowCount) + additionalRowCount} rowHeight={this._rowHeightBottomGrid} style={this._bottomLeftGridStyle} tabIndex={null} width={gridWidth} />;

    if (hideBottomLeftGridScrollbar) {
      return <div className="BottomLeftGrid_ScrollWrapper" style={{ ...this._bottomLeftGridStyle,
        height,
        width,
        overflowY: 'hidden'
      }}>
  ...
  _renderTopLeftGrid(props) {
    ...
    return <Grid {...props} className={this.props.classNameTopLeftGrid} columnCount={fixedColumnCount} height={this._getTopGridHeight(props)} ref={this._topLeftGridRef} rowCount={fixedRowCount} style={this._topLeftGridStyle} tabIndex={null} width={this._getLeftGridWidth(props)} />;
  }
