...
class Grid extends React.PureComponent<Props, State> {
    ...
    _deferredInvalidateColumnIndex: any = null
    _deferredInvalidateRowIndex: any = null
    ...
    constructor(props: Props) {
        super(props)
        const columnSizeAndPositionManager =
            new ScalingCellSizeAndPositionManager({
        ...
        const rowSizeAndPositionManager = new ScalingCellSizeAndPositionManager(
            {
                ...
                cellSizeGetter: (params) =>
                    Grid._wrapSizeGetter(props.rowHeight)(params),
        ...
        if (props.scrollToRow > 0) {
            this._initialScrollTop = this._getCalculatedScrollTop(
                props,
                this.state
            )
        }
