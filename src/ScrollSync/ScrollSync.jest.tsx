...
describe('ScrollSync', () => {
  it('should pass through an initial value of 0 for :scrollLeft and :scrollTop', () => {
    const component = render(<ScrollSync>
        {({
        clientHeight,
        clientWidth,
        scrollHeight,
        ...
        scrollTop,
        scrollWidth
      }) => <ChildComponent clientHeight={clientHeight} clientWidth={clientWidth} scrollHeight={scrollHeight} scrollLeft={scrollLeft} scrollTop={scrollTop} scrollWidth={scrollWidth} />}
      </ScrollSync>);
