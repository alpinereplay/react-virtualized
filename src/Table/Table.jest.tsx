...
describe('Table', () => {
  ...
  function getMarkup({
    ...
    return <Table headerHeight={20} height={100} overscanRowCount={0} overscanIndicesGetter={overscanIndicesGetter} rowCount={list.size} rowGetter={immutableRowGetter} rowHeight={10} width={100} {...flexTableProps}>
        <Column label={label || 'Name'} dataKey="name" columnData={columnData} width={50} cellRenderer={cellRenderer} cellDataGetter={cellDataGetter} headerRenderer={headerRenderer} disableSort={disableSort} defaultSortDirection={defaultSortDirection} style={columnStyle} headerStyle={columnHeaderStyle} id={columnID} />
