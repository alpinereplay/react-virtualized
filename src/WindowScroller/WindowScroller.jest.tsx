...
function getMarkup({
  ...
  const windowScroller = <WindowScroller {...props}>
...
describe('WindowScroller', () => {
  ...
  describe('updatePosition', () => {
    ...
    it('should recalculate the offset from the top when the window resizes', () => {
      let windowScroller;
      render(getMarkup({
        headerElements: <div id="header" style={{
          height: 100,
          width: 150
        }} />,
        ref: ref => {
  ...
  describe('when child scrolls', () => {
    ...
    beforeEach(() => {
      ...
      window.scrollTo = (scrollX, scrollY) => simulateWindowScroll({
        scrollX,
        scrollY
      });
    });
