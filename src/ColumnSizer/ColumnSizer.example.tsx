...
export default class ColumnSizerExample extends React.PureComponent {
  ...
  render() {
    ...
    return <ContentBox>
        <ContentBoxHeader text="ColumnSizer" sourceLink="https://github.com/bvaughn/react-virtualized/blob/master/source/ColumnSizer/ColumnSizer.example.js" docsLink="https://github.com/bvaughn/react-virtualized/blob/master/docs/ColumnSizer.md" />
        ...
        <InputRow>
          ...
          <LabeledInput label="Column Min Width" name="columnMinWidth" onChange={this._noColumnMinWidthChange} value={columnMinWidth} />
          <LabeledInput label="Column Max Width" name="columnMaxWidth" onChange={this._noColumnMaxWidthChange} value={columnMaxWidth} />
        </InputRow>
        ...
        <div>
          <AutoSizer disableHeight>
            {({
            width
          }) => <ColumnSizer columnMaxWidth={columnMaxWidth} columnMinWidth={columnMinWidth} columnCount={columnCount} key="GridColumnSizer" width={width}>
                {({
              adjustedWidth,
              columnWidth,
              registerChild
              ...
              width: adjustedWidth
                    ...
                    <Grid ref={registerChild} columnWidth={columnWidth} columnCount={columnCount} height={50} noContentRenderer={this._noContentRenderer} cellRenderer={this._cellRenderer} rowHeight={50} rowCount={1} width={adjustedWidth} />
                  </div>}
              </ColumnSizer>}
          </AutoSizer>
        </div>
