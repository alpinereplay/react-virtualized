...
class Masonry extends React.PureComponent<Props, State> {
  ...
  render() {
    ...
    this._positionCache.range(Math.max(0, scrollTop - overscanByPixels), height + overscanByPixels * 2, (index: number, left: number, top: number) => {
    ...
    return <div ref={this._setScrollingContainerRef} aria-label={this.props['aria-label']} className={clsx('ReactVirtualized__Masonry', className)} id={id} onScroll={this._onScroll} role={role} style={{
      ...
      ...style
        ...
        <div className="ReactVirtualized__Masonry__innerScrollContainer" style={{
        width: '100%',
