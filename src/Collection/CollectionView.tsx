...
class CollectionView extends React.PureComponent {
    ...
    private _calculateSizeAndPositionDataOnNextUpdate = false
    // Invokes callbacks only when their values have changed.
    private _onSectionRenderedMemoizer = createCallbackMemoizer()
    private _onScrollMemoizer = createCallbackMemoizer(false)
    ...
    static getDerivedStateFromProps(
        nextProps: { cellCount: number; scrollLeft: null; scrollTop: null },
        prevState: { scrollLeft: number; scrollTop: number }
    ) {
        if (
    ...
    componentDidUpdate(
        ...
        prevState: { scrollLeft: any; scrollTop: any }
    ) {
