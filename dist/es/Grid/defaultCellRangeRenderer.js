 ...
 */
function defaultCellRangeRenderer({ cellCache, cellRenderer, columnSizeAndPositionManager, columnStartIndex, columnStopIndex, deferredMeasurementCache, horizontalOffsetAdjustment, isScrolling, isScrollingOptOut, parent, 
// Grid (or List or Table)
rowSizeAndPositionManager, rowStartIndex, rowStopIndex, styleCache, verticalOffsetAdjustment, visibleColumnIndices, visibleRowIndices, }) {
    const renderedCells = [];
    ...
    for (let rowIndex = rowStartIndex; rowIndex <= rowStopIndex; rowIndex++) {
        ...
        for (let columnIndex = columnStartIndex; columnIndex <= columnStopIndex; columnIndex++) {
            ...
            if (!renderedCell.props.role) {
                renderedCell = react_1.default.cloneElement(renderedCell, {
                    role: "gridcell",
                });
            }
