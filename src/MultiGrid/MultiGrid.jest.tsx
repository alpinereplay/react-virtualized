...
describe('MultiGrid', () => {
  ...
  function getMarkup(props = {}) {
    return <MultiGrid cellRenderer={defaultCellRenderer} columnCount={50} columnWidth={50} fixedColumnCount={2} fixedRowCount={1} height={300} overscanColumnCount={0} overscanRowCount={0} autoHeight={false} rowHeight={20} rowCount={100} width={400} {...props} />;
  }
  ...
  describe('scrollTop and scrollLeft', () => {
    ...
    it('should not crash when decreasing :rowCount', () => {
      render(getMarkup());
      const updated = render(getMarkup({
        rowCount: 2
      }));
