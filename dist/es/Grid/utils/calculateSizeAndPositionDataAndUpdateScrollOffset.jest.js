...
const calculateSizeAndPositionDataAndUpdateScrollOffset_1 = __importDefault(require("./calculateSizeAndPositionDataAndUpdateScrollOffset"));
describe("calculateSizeAndPositionDataAndUpdateScrollOffset", () => {
    function helper({ cellCount = 100, cellSize = 10, computeMetadataCallbackProps = {}, nextCellsCount = 100, nextCellSize = 10, nextScrollToIndex, scrollToIndex, } = {}) {
        ...
        (0, calculateSizeAndPositionDataAndUpdateScrollOffset_1.default)({
            ...
            nextScrollToIndex,
            scrollToIndex,
            updateScrollOffsetForScrollToIndex: () => updateScrollOffsetForScrollToIndexCalls.push(1),
        });
        return {
