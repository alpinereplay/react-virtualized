...
describe('List', () => {
  ...
  function getMarkup(props = {}) {
    function rowRenderer({
      ...
      return <div className="listItem" key={key} style={style}>
          {names.get(index)}
        </div>;
    }

    return <List height={100} overscanIndicesGetter={overscanIndicesGetter} overscanRowCount={0} rowHeight={10} rowCount={names.size} rowRenderer={rowRenderer} width={100} {...props} />;
  }
