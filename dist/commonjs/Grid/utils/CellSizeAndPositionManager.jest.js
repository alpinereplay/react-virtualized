...
describe("CellSizeAndPositionManager", () => {
    function getCellSizeAndPositionManager({ cellCount = 100, estimatedCellSize = 15, } = {}) {
        ...
        const cellSizeAndPositionManager = new CellSizeAndPositionManager_1.default({
            cellCount,
    ...
    describe("getUpdatedOffsetForIndex", () => {
        function getUpdatedOffsetForIndexHelper({ align = "auto", cellCount = 10, cellSize = 10, containerSize = 50, currentOffset = 0, estimatedCellSize = 15, targetIndex = 0, }) {
            const cellSizeAndPositionManager = new CellSizeAndPositionManager_1.default({
                cellCount,
