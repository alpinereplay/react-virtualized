...
export default class Collection extends React.PureComponent {
    ...
    public _cellMetadata: any[] = []
    public _lastRenderedCellIndices: number[] = []
    public _cellCache: any[] = []
    public _collectionView: any
    public _sectionManager: any
    ...
    getScrollPositionForCell({
        ...
        const { cellCount } = this.props as any
    ...
    cellRenderers({ height, isScrolling, width, x, y }: any) {
        const { cellGroupRenderer, cellRenderer } = this.props as any
    ...
    _isScrollingChange(isScrolling: boolean) {
        if (!isScrolling) {
            this._cellCache = []
        }
    }

    _setCollectionViewRef(ref: any) {
...
function defaultCellGroupRenderer({
    ...
    return indices
        ...
        .filter((renderedCell: any) => !!renderedCell)
}
