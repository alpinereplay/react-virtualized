...
export default class DynamicHeightList extends React.PureComponent {
  ...
  render() {
    ...
    return <List className={styles.BodyGrid} deferredMeasurementCache={this._cache} height={400} overscanRowCount={0} rowCount={1000} rowHeight={this._cache.rowHeight} rowRenderer={this._rowRenderer} width={width} />;
  }
  ...
  _rowRenderer({
    ...
    return <CellMeasurer cache={this._cache} columnIndex={0} key={key} rowIndex={index} parent={parent}>
        ...
        registerChild
            ...
            <img onLoad={measure} src={source} style={{
          width: imageWidth
        }} />
          </div>}
      </CellMeasurer>;
