...
describe("overscanIndicesGetter", () => {
    function testHelper({ cellCount, startIndex, stopIndex, overscanCellsCount, scrollDirection, }) {
        return (0, defaultOverscanIndicesGetter_1.default)({
            cellCount,
            overscanCellsCount,
            scrollDirection,
            startIndex,
    ...
    it("should not overscan if :overscanCellsCount is 0", () => {
        expect(testHelper({
            ...
            scrollDirection: defaultOverscanIndicesGetter_1.SCROLL_DIRECTION_BACKWARD,
        })).toEqual({
        ...
        expect(testHelper({
            ...
            stopIndex: 20,
            overscanCellsCount: 0,
            scrollDirection: defaultOverscanIndicesGetter_1.SCROLL_DIRECTION_FORWARD,
        })).toEqual({
            overscanStartIndex: 10,
            overscanStopIndex: 20,
        });
