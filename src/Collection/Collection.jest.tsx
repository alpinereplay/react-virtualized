...
describe('Collection', () => {
  ...
  function getMarkup(props = {}) {
    ...
    return <Collection cellCount={cellCount} cellRenderer={defaultCellRenderer} cellSizeAndPositionGetter={defaultCellSizeAndPositionGetter} height={SECTION_SIZE} sectionSize={SECTION_SIZE} width={SECTION_SIZE * 2} {...props} />;
  }
